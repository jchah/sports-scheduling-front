...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      axios.put(`https://sports-scheduling-f7o5.onrender.com/events/${this.$route.params.id}`, eventData)
          .then(() => {
    ...
    fetchEventDetails() {
      axios.get(`https://sports-scheduling-f7o5.onrender.com/events/${this.$route.params.id}`)
          .then(response => {
